...
def main():
    ...
    if development:
        ...
        # in order for development env to work, must be set to development here locally. This condition (hopefully) takes care of that. We shall see if "if/elif" works in production. Works in development.
